...
import sin1 from '../../assets/images/products/default/1-800x900.jpg';
import swipeImg from '../../assets/images/products/default/6.jpg'
import swipe2 from '../../assets/images/products/default/5.jpg'
import swipe3 from '../../assets/images/products/default/7-1.jpg'
import swipe4 from '../../assets/images/products/default/7-2.jpg'
const SinglePage = () => {
  return (
    <>
                ...
                <div className="col-md-6 mb-4 mb-md-6">
                  ...
                  >
                    ...
                    <div className="product-short-desc">
                      <ul className="list-type-check list-style={{backgroundColor: '{{backgroundColor: '-none">
                        <li>
                  ...
                  <div className="tab-pane" id="product-tab-vendor">
                    <div className="row mb-3">
                      ...
                      <div className="col-md-6 pl-2 pl-md-6 mb-4">
                        ...
                        <ul className="vendor-info list-style={{backgroundColor: '{{backgroundColor: '-none">
                    ...
                    <div className="tab tab-nav-boxed tab-nav-outline tab-nav-center">
                      ...
                      <div className="tab-content">
                        <div className="tab-pane active" id="show-all">
                          <ul className="comments list-style={{backgroundColor: '{{backgroundColor: '-none">
